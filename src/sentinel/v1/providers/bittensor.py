...
from sentinel.v1.providers.turbobt import BittensorClient
...
class BittensorProvider:
    ...
    def get_extrinsics(self, block_hash: str) -> None | Extrinsic:
        """
        ...
        Returns:
            List of extrinsics as dictionaries, or None if not found
